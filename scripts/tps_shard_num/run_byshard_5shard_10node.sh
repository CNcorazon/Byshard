...
BEACON_PORT=10057
BEACON_IP="127.0.0.1"
SHARD_PORTS="20057,21057,22057,23057,24057"
SHARD_IPS="192.168.0.166,192.168.0.166,192.168.0.166,192.168.0.166,192.168.0.166"
# SHARD_IPS="127.0.0.1,127.0.0.1,127.0.0.1,127.0.0.1,127.0.0.1"
...
cp -r test/tps_shard_num/elrond_5shard_10node/* $TM_HOME
